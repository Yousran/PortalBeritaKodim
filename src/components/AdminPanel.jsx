    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">{news.length} berita terpublikasi</p>
        </div>
        {!showForm && (
          <motion.button
            whileTap={{ scale: 0.95 }}
        ...
        {showForm && (
          ...
          >
            <div className="p-5 border-b border-gray-100 flex items-center justify-between">
              ...
              <button type="button" onClick={resetForm} className="p-1.5 hover:bg-gray-100 rounded-lg">
            ...
            <div className="p-5 space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 border border-gray-300 rounded-xl text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none"
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3.5 py-2.5 border border-gray-300 rounded-xl text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none bg-white"
                  >
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3.5 py-2.5 border border-gray-300 rounded-xl text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none resize-none"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-9 pr-3.5 py-2.5 border border-gray-300 rounded-xl text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none"
                      placeholder="https://..."
                    />
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1.5">URL Avatar Penulis</label>
                  <input
                ...
                <div className="flex items-end">
                  <label className="flex items-center gap-3 cursor-pointer px-3.5 py-2.5 border border-gray-300 rounded-xl w-full hover:bg-gray-50 transition-colors">
                    <input
                      type="checkbox" checked={form.trending}
                      onChange={(e) => setForm({ ...form, trending: e.target.checked })}
                      className="w-4 h-4 text-indigo-600 rounded focus:ring-indigo-500"
                    />
                    <span className="text-sm text-gray-700 font-medium">Tandai sebagai Trending</span>
                  </label>
                </div>
              </div>
          ...
          >
            ...
            <div className="flex items-center gap-1.5 shrink-0">
              <button onClick={() => handleEdit(item)}
                className="p-2 hover:bg-indigo-50 rounded-lg text-indigo-600 transition-colors" title="Edit">
                <Edit3 size={16} />
              </button>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          ...
          <div className="flex gap-2">
            <input value={form.posts}
              ...
              className="flex-1 px-3.5 py-2.5 border border-gray-300 rounded-xl text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none"
      ...
      <div className="space-y-2">
        {trending.map((item, index) => (
          <div key={item.id} className="bg-white rounded-xl border border-gray-200 px-4 py-3 flex items-center gap-3">
            ...
            <button onClick={() => handleEdit(item)} className="p-1.5 hover:bg-indigo-50 rounded-lg text-indigo-600">
              <Edit3 size={15} />
            </button>
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-gray-200 p-4 space-y-3">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <input required value={form.name}
            ...
            className="px-3.5 py-2.5 border border-gray-300 rounded-xl text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none"
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-5 space-y-4">
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1.5">Teks Breaking News</label>
          <textarea
            value={draft} rows={3}
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              <a href="/" className="flex items-center gap-2 no-underline text-gray-500 hover:text-indigo-600 transition-colors">
                <ArrowLeft size={20} />
              </a>
            ...
            <div className="flex items-center gap-2">
              <a href="/" target="_blank"
                className="flex items-center gap-1.5 px-3 py-2 text-sm font-medium text-gray-600 hover:text-indigo-600 hover:bg-indigo-50 rounded-lg transition-colors no-underline">
